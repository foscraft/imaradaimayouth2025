...
st.markdown("""
    ...
    /* Hide Streamlit branding, including Streamlit Cloud footer */
    ...
    .css-1v3fvcr {display: none;} /* Targets Streamlit Cloud footer */
    .css-1v0mbdj img {display: none;} /* Hides profile picture */
    .css-1v0mbdj {display: none;} /* Hides entire footer container */
    </style>
